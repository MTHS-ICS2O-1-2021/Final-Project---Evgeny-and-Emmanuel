...
class TitleScene extends Phaser.Scene {
  constructor() {
    ...
    this.titleSceneTextStyle = { font: "100px Pixelo", fill: "#000000", align: "center" }
  }
  ...
  create(data) {
    ...
    this.titleSceneText = this.add.text(1920 / 2, (1080 / 2) - 50, "Fofeyin & Vovk Presents", this.titleSceneTextStyle).setOrigin(0.5)
  }
