...
class HardLvlThreeGameScene extends Phaser.Scene {
  ...
  createRocks() {
    ...
    const rockYLocation = Math.floor(verticalRockYLocation + 900) + 1 //spawns the rock between 1 and 1921 pixel
    const aRock = this.physics.add
      .sprite(2020, rockYLocation, "magmaRock")
      .setImmovable()
    aVerticalRock.body.velocity.x = -1300
    this.verticalRockGroup.add(aVerticalRock)
    aRock.body.velocity.x = -1300
  ...
  createBattleCat() {
    ...
    const aBattleCat = this.physics.add
      ...
      .setScale(0.5)
    aBattleCat.body.velocity.x = -600
  ...
  createFishSkeleton() {
    ...
    const aFishSkeleton = this.physics.add
      ...
      .setScale(0.5)
    aFishSkeleton.body.velocity.x = -600
  ...
  createBluePortal() {
    ...
    const aBluePortal = this.physics.add
      ...
      .setScale(0.5)
      .setImmovable()
    aBluePortal.body.velocity.x = -1000
  ...
  createRedPortal() {
    ...
    const aRedPortal = this.physics.add
      ...
      .setImmovable()
    aRedPortal.body.velocity.x = -1000
  ...
  createPurplePortal() {
    ...
    const aPurplePortal = this.physics.add
      ...
      .setImmovable()
    aPurplePortal.body.velocity.x = -1000
   ...
   */
  preload() {
    console.log("Hard Mode Level Three Game Scene")
    ...
    this.load.image("bullyMeText", "./assets/bullyMeText.png")
    this.load.image("madFloppa", "./assets/madFloppa.png")
  }
  ...
  create(data) {
    ...
    this.physics.add.collider(
      ...
      function (bigFloppaCollide, finishLevelCollide) {
        ...
        this.bullyMeText = this.add.sprite(
          1920 / 2 + 225,
          1080 / 2 - 250,
          "bullyMeText"
        )
        this.madFloppa = this.add.sprite(
          1920 / 2 - 225,
          1080 / 2 - 250,
          "madFloppa"
        )
    ...
    this.physics.add.collider(
      ...
      function (dogeCollide, rockCollide) {
        ...
        this.retryButton.on("pointerdown", () =>
          this.scene.start("hardLvlThreeGameScene")
        )
...
export default HardLvlThreeGameScene
